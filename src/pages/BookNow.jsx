...
const RoomDetails = () => {
  ...
  useEffect(() => {
    ...
    console.log({
      ...
      days: (CheckOut - CheckIn) / MILLISECONDS_IN_A_DAY,
    });
    setCategory(array);
    setSampleRoom(array);
  }, [Data, RoomTypeName]);
        ...
        <>
          <div className="bg-room bg-cover bg-center h-[560px] relative flex justify-center items-center">
            <div className="absolute w-full h-full bg-black/75">
              <h1 className="text-6xl text-white z-20 font-primary text-center sm:mt-52">
                {" "}
                ...
                <div className=" py-8 px-6 bg-accent/20 mb-12 ">
                  <div className="flex flex-col space-y-4 mb-4">
                    ...
                    <div className="flex gap-6 h-full">
                      <div className="w-full h-full flex flex-col ">
                        ...
                        <input
                          ...
                          value={FirstName}
                          onChange={(e) =>
                            dispatch(RoomActions.setFirstName(e.target.value))
                          }
                          className="p-4"
                          required
                        />
                      ...
                      <div className="w-full h-full flex flex-col ">
                        ...
                        <input
                          ...
                          value={LastName}
                          onChange={(e) =>
                            dispatch(RoomActions.setLastName(e.target.value))
                          }
                          className="p-4"
                          required
                        />
                    ...
                    <div className="flex gap-6 h-full">
                      <div className="w-full h-full flex flex-col ">
                        ...
                        <input
                          ...
                          value={Email}
                          onChange={(e) =>
                            dispatch(RoomActions.setEmail(e.target.value))
                          }
                          className="p-4"
                          required
                        />
                      ...
                      <div className="w-full h-full flex flex-col ">
                        ...
                        <input
                          ...
                          value={Phone}
                          onChange={(e) =>
                            dispatch(RoomActions.setPhone(e.target.value))
                          }
                          className="p-4"
                          required
                        />
                    ...
                    <div className="flex gap-6 h-full">
                      <div className="w-full h-full flex flex-col ">
                        ...
                        <textarea
                          ...
                          value={Address}
                          onChange={(e) =>
                            dispatch(RoomActions.setAddress(e.target.value))
                          }
                          className="p-4"
                          required
                        />
                    ...
                    >
                      Book now for ₦
                      {(
                        ((CheckOut - CheckIn) / MILLISECONDS_IN_A_DAY) *
                        24999
                      ).toLocaleString()}
                    </button>
                  </div>
